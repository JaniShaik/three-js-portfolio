...
const About = () => {
    ...
    const handleCopy = () => {
        navigator.clipboard.writeText('shaik2signin@gmail.com');
        setHasCopied(true);
            ...
            <div className="grid xl:grid-cols-3 xl:grid-rows-6 md:grid-cols-2 grid-cols-1 gap-5 h-full">
                <div className="col-span-1 xl:row-span-3">
                    <div className="grid-container">
                        ...
                        <div>
                            <p className="grid-headtext">Hi, I'm Jani</p>
                            <p className="grid-subtext">With 9 years of experience, I have honed my skills in frontend and backend development, with a focus on animated
                            3D websites.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div className="grid-container">
                        ...
                        <div className="space-y-2">
                            ...
                            <div className="copy-container" onClick={handleCopy}>
                                ...
                                <p className="lg:text-2xl md:text-xl font-medium text-gray_gradient text-white">shaik2signin@gmail.com</p>
                            </div>
                        </div>
                    </div>
                </div>
